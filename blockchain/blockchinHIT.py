...
def welcome():
    wl = '''
        ...
        <br>
            <ul>
            <li> '/mine', methods=['GET'] </li>
            <li> '/transactions/new', methods=['POST'] </li>
            <li> '/chain', methods=['GET'] </li>
            <li> '/nodes/register', methods=['POST'] </li>
            <li> '/nodes/resolve', methods=['GET'] </li>
            </ul>
        </body>
        </html>
        '''
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5000)  # 服务器运行端口 5000